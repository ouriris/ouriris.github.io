...
下面是几个图示说明：
![01](/images/RBTree/delete/delete_01.png)
...
a) **被删除的D节点为红色**。这种情况，则与D相关的颜色以及结构关系必然只有如下一种情况(为什么只有这种情况，不明白的请看红黑树的性质)：![02](/images/RBTree/delete/delete_02.png)
...
如前所述，如果DR不为Nil，则D、DR必为如下情况：![03](/images/RBTree/delete/delete_03.png)
...
d.1> **SL为红，SR颜色任意情况**
![06](/images/RBTree/delete/delete_06.png)
...
d.2> **SR为红色，SL颜色任意的情况**
![07](/images/RBTree/delete/delete_07.png)
...
```
了解红黑树及所有代码实现，请看另一篇博客 [初探红黑树](https://littlekelvin.github.io/2017/01/15/R-B-Tree/)